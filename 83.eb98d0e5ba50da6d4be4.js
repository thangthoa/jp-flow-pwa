...
const v=e=>{const{shippingData:t,onCancel:a,onSuccess:s,isGuestCheckout:l,optionsFormProps:c,asyncForm:d,refetchCustomerAddresses:u}=e,m=Object(b.b)({shippingData:t,onSuccess:s,refetchCustomerAddresses:u}),{handleSubmit:v,initialValues:w,isSaving:S,isUpdate:k,fields:C}=m,F=Object(r.useMemo)(()=>C.map(e=>o.a.createElement(p.a,n()({key:e.id,fieldKey:Object(y.d)(e.attribute_code)},e))),[C]),{formatMessage:M}=Object(O.a)(),I=Object(i.a)(g,e.classes),_=d||!k&&!a?null:o.a.createElement(f.a,{disabled:S,onClick:a,priority:"low"},o.a.createElement(h.a,{id:"global.cancelButton",defaultMessage:"Cancel"})),P=M(k?{id:"global.updateButton",defaultMessage:"Update"}:{id:"global.addButton",defaultMessage:"Add"}),A={disabled:S,priority:k?"high":"normal",type:"submit"},T=d?null:o.a.createElement("div",{className:I.buttons},_,o.a.createElement(f.a,A,P)),B=l?o.a.createElement(E.h,{field:"save_in_address_book",initialValue:!0,type:"hidden"}):o.a.createElement("div",{className:I.checkboxContainer},o.a.createElement(j.a,{id:"save_in_address_book",field:"save_in_address_book",initialValue:!0,label:M({id:"amOsc.saveInAddressBook",defaultMessage:"Save in address book"})})),D=l||d?null:o.a.createElement("div",{className:I.checkboxContainer},o.a.createElement(j.a,{id:"default_shipping",field:"default_shipping",label:M({id:"customerForm.defaultShipping",defaultMessage:"Make this my default address"})}))
return o.a.createElement(E.b,n()({className:I.root,onSubmit:v,initialValues:w},c,{allowEmptyStrings:!0}),F,d&&B,D,T)}
...
let a=null
U||!1!==t?t&&2===n&&(a=T):a=A,e&&u(t),g(a)},[u,V,U,n])
...
let D=null
c===A?D=o.a.createElement(V,{handleForgotPassword:n,handleSignIn:u}):c===T&&(D=o.a.createElement(W,null))
...
const{checkoutInformationData:{shipping_addresses:t}}=e,a=Object(i.a)(X.c,e.operations),{setShippingAddressMutation:s}=a,n=Object(r.useRef)(),o=Object(r.useRef)(t[0]),[{cartId:l}]=Object(P.b)(),[{checkoutFields:c,shouldSubmit:d,getSelectedAndAvailableShippingMethod:u},{setIsUpdating:m,setSectionError:g,setSectionCompleted:b}]=Object(y.b)(),p=Object(r.useCallback)(e=>g(["ADDRESS_FORM",e]),[g]),f=Object(r.useCallback)(()=>b("ADDRESS_FORM"),[b]),[O,{error:h,setGuestAddressLoading:j}]=Object(C.a)(s,{onCompleted:()=>{u({variables:{cartId:l}}),f()}}),E=Object(r.useMemo)(()=>Object(te.f)(c),[c]),v=Object(r.useCallback)(async e=>{const{validate:t}=n.current
try{await O({variables:{cartId:l,address:_objectSpread(_objectSpread({},e),{},{custom_attributes:Object(te.b)(e.custom_attributes)})}}),m(!1)}catch(e){t(),m(!1),p(e)}},[O,m,n,l,p]),w=Object(r.useCallback)(e=>{const{validate:a,getState:s}=n.current,{errors:r}=s(),o=t[0],i=Object(te.c)(_objectSpread(_objectSpread({},o),e)),{country_id:l,region:c}=e,d=o&&o.country&&l!==o.country.code,u=E.every(t=>{const[a,s]=t.split(".")
return s?e[a]&&e[a][s]:e[t]})&&!Object.keys(r).length
if(d||u)return c?v(i):a()
m(!1)},[m,n,t,v,E]),S=Object(r.useMemo)(()=>ee()(w,500),[w]),k={getApi:e=>n.current=e,onValueChange:e=>{m(!0),S(e)}}
Object(r.useEffect)(()=>{if(t[0]){const e=Object(te.c)(t[0])
m(!0),v(e)}},[]),Object(r.useEffect)(()=>{if(d)try{const{validate:e,getState:t}=n.current||{}
e()
const{errors:a}=t()
if(Object.keys(a).length)throw new Error("Errors in the address form")
return b("ADDRESS_FORM")}catch(e){return p(e)}},[d,n,b,p])
const F=Object(r.useMemo)(()=>new Map([["setGuestShippingMutation",h]]),[h]),M=Object(r.useMemo)(()=>{const e=_objectSpread({},o.current)
return Object.entries(e).reduce((e,t)=>{let[a,s]=t
const n=Array.isArray(s)?s.filter(e=>"-"!==e).join():s
return n&&"-"!==n&&(e[a]=s),e},{})},[o])
return{errors:F,isSaving:j,handleSubmit:v,optionsFormProps:k,shippingData:M}}(e),n=Object(i.a)({},e.classes),l=t?o.a.createElement(M.b,null,o.a.createElement($,e)):null
